...
class NeuronGraph {
    ...
    createHTML() {
        ...
        container.innerHTML = `
            <div class="neuron-graph-container" style="
                ...
                position: relative;
            ">
                <canvas id="${canvasId}" width="1000" height="400" style="
                    width: 100%;
                    height: 400px;
                ...
                ">
                    <div class="legend-item" style="display: flex; align-items: center; gap: 8px;">
                        ...
                        <span style="color: #000000; font-family: 'Inter Tight, Roboto, sans-serif'; font-size: 12px; font-weight: 500;">PV</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <div style="width: 16px; height: 3px; background-color: #0F7BCE; border-radius: 2px;"></div>
                        <span style="color: #000000; font-family: 'Inter Tight, Roboto, sans-serif'; font-size: 12px; font-weight: 500;">SST</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <div style="width: 16px; height: 3px; background-color: #10B981; border-radius: 2px;"></div>
                        <span style="color: #000000; font-family: 'Inter Tight, Roboto, sans-serif'; font-size: 12px; font-weight: 500;">VIP</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <div style="width: 16px; height: 3px; background-color: #8B5CF6; border-radius: 2px;"></div>
                        <span style="color: #000000; font-family: 'Inter Tight, Roboto, sans-serif'; font-size: 12px; font-weight: 500;">LAMP5</span>
                </div>
            </div>
        `;
    }
    ...
    drawGrid() {
        const width = this.canvas.offsetWidth || parseInt(this.canvas.style.width) || 1000;
    ...
    this.ctx.font = '12px Inter Tight, Roboto, sans-serif';
        ...
        // Axis titles
        this.ctx.fillStyle = '#000000';
    this.ctx.font = 'bold 14px Inter Tight, Roboto, sans-serif';
        this.ctx.textAlign = 'center';
