document.addEventListener("DOMContentLoaded", () => {
    const publications = [
        {
            id: 1,
            date: '2019',
            title: 'Developing Brain Atlas through Deep Learning Developing Brain Atlas through Deep Learning Developing Brain Atlas through Deep Learning  Deep Learning Developing Brain Atlas through Deep Learning  Deep Learning Developing Brain Atlas through Deep Learning  Deep Learning Developing Brain Atlas through Deep Learning  Deep Learning Developing Brain Atlas through Deep Learning ',
            authors: 'Rahel Kastli, Rasmus Vighagen, Alexander van der Bourg, Ali Özgür Argunsah, Asim Iqbal, Fabian F. Voigt Rahel Kastli, Rasmus Vighagen, Alexander van der Bourg, Ali Özgür Rahel Kastli, Rasmus Vighagen, Alexander van der Bourg, Ali Özgür',
        ...
        },
        {
            id: 2,
            date: '2020',
            title: 'Developmental divergence of sensory stimulus representation in cortical interneurons Developmental divergence of sensory stimulus representation in cortical interneurons Developmental divergence of sensory stimulus representation in cortical interneurons Developmental divergence of sensory stimulus representation in cortical interneurons Developmental divergence of sensory stimulus representation in cortical interneurons Developmental divergence of sensory stimulus representation in cortical interneurons Developmental divergence of sensory stimulus representation in cortical interneurons',
            authors: '8Rahel Kastli, Rasmus Vighagen, Alexander van der Bourg, Ali Özgür Argunsah, Asim Iqbal, Fabian F. Voigt, Asim Iqbal, Fabian F. Voigt, Asim Iqbal, Fabian F. Voigt, Asim Iqbal, Fabian F. Voigt, Asim Iqbal, Fabian F. Voigt',
        ...
        },
        {
            ...
            authors: 'Meredith Ringel Morris, et al Meredith Ringel Morris, et al Meredith Ringel Morris, et al Meredith Ringel Morris, et al Meredith Ringel Morris, et al ',
            conference: 'ICML 2024',
    ...
    function createList(data) {
        ...
        let displayedAuthors = data.authors;
        if (displayedAuthors.length > 100) {
            displayedAuthors = displayedAuthors.slice(0, 100) + '...';
        }
    ...
    if (truncatedTitle.length > 100) {
        truncatedTitle = truncatedTitle.slice(0, 100) + '...';
    }
        ...
        list.innerHTML = `
            ...
            <div class="list-body">
                <div class="list-title">${truncatedTitle}</div>
